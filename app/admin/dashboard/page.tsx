      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center space-x-3">
            <Link href="/" className="inline-block md:hidden p-2 border border-gray-300 rounded-md">
              <svg
                ...
                strokeWidth={2}
                stroke="currentColor"
                className="w-6 h-6 text-gray-800 hover:text-red-600 transition-colors duration-200"
                aria-label="Home"
              >
                <path
                  strokeLinecap="round"
